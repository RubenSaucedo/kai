...
#
# TEMPLATE. Your real file lives at personal/proactive/channels.md, which is
# gitignored (the whole personal/ lane is). It binds ONE consented channel for
...
- kai's `workflow-proactive-scan` only **emits** the payload to
  `personal/proactive/outbox/`. Your external runner reads consent here and
