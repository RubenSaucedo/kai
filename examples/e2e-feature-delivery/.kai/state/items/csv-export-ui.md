...
artifact_targets:
  - .kai/state/initiatives/csv-export/artifacts/design-ui.md
context_artifacts:
...
completed_reviews:
  - role: principal-product-designer
    kind: design-conformance
    change_ref: 9b2d017
    evidence: .kai/state/threads/csv-export-ui.md
    verdict: approved
...
- Design: `.kai/state/initiatives/csv-export/artifacts/design-ui.md`
