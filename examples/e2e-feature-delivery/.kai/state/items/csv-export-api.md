...
artifact_targets:
  - .kai/state/initiatives/csv-export/artifacts/design-api.md
context_artifacts:
  - .kai/state/initiatives/csv-export/artifacts/brief.md
  - .kai/state/initiatives/csv-export/artifacts/decision.md
touches:
...
completed_reviews:
  - role: principal-swe-architect
    kind: independent-code
    change_ref: 4f1c8ae
    evidence: .kai/state/threads/csv-export-api.md
    verdict: approved
...
- Design: `.kai/state/initiatives/csv-export/artifacts/design-api.md`
...
- Ship record: `.kai/state/initiatives/csv-export/artifacts/ship-log.md` — readiness
