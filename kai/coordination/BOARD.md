...
| pack-split-onboarding-installer | Honest guided onboarding installer | pack-split | five-pack-split-shipped | 20 | in-review | principal-swe-infra | principal-swe-architect | generated-pack-trees (shipped), migration-doctor (shipped), pack-dependency-manifests (shipped) — all met | — | 2026-08-27-1221 |
