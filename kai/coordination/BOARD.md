...
| pack-split-crosspack-validator | Cross-pack reference validator (3 firing paths + assets + hooks-once) | pack-split | dependency-guarantees | 20 | in-review | principal-swe-infra | workflow-ship | generator-gates (shipped ✅ 2026-08-25) | — | 2026-08-25-1428 |
...
| pack-split-degraded-refusal | Canonical degraded-mode refusal block, CI-pinned | pack-split | dependency-guarantees | 40 | ready | — | principal-swe-infra | preflight-compat (shipped ✅ 2026-08-25) — **sole dependency met; dispatchable**, touch-conflict check with crosspack-validator still applies | — | 2026-08-25-1328 |
| pack-split-ci-partition-checks | Real CI partition/collision/skew gates + namespace (fleet rename) | pack-split | dependency-guarantees | 50 | ready | — | principal-swe-infra | preflight-compat (shipped ✅ 2026-08-25), crosspack-validator (shipped — **unmet**); still not dispatchable | — | 2026-08-25-1328 |
| pack-split-generated-pack-trees | Generate committed-unpublished core + personal trees | pack-split | first-pack-extracted | 20 | proposed | — | principal-product-manager | generator-gates (shipped ✅ 2026-08-25), preflight-compat (shipped ✅ 2026-08-25), crosspack-validator, degraded-refusal, ci-partition-checks (shipped); host-semantics-spike (completed) — 2 of 6 met | — | 2026-08-25-1328 |
