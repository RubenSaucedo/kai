...
| pack-split-degraded-refusal | Canonical degraded-mode refusal block, CI-pinned | pack-split | dependency-guarantees | 40 | ready | — | principal-swe-infra | preflight-compat (shipped ✅ 2026-08-25) — **sole dependency met; dispatchable**, touch-conflict check with crosspack-validator (now landed on `main` as `v0.60.0`) still applies | — | 2026-08-25-1440 |
| pack-split-ci-partition-checks | Real CI partition/collision/skew gates + namespace (fleet rename) | pack-split | dependency-guarantees | 50 | ready | — | principal-swe-infra | preflight-compat (shipped ✅ 2026-08-25), crosspack-validator (shipped ✅ 2026-08-25) — **both dependencies met; dispatchable**; touch-conflict check on pack-plan.mjs / validate-plugin.mjs / pack-preview.mjs / validate.yml still applies | — | 2026-08-25-1440 |
| pack-split-generated-pack-trees | Generate committed-unpublished core + personal trees | pack-split | first-pack-extracted | 20 | proposed | — | principal-product-manager | generator-gates (shipped ✅ 2026-08-25), preflight-compat (shipped ✅ 2026-08-25), crosspack-validator (shipped ✅ 2026-08-25), degraded-refusal, ci-partition-checks (shipped); host-semantics-spike (completed) — 3 of 6 met | — | 2026-08-25-1440 |
