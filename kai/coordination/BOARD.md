...
| area-plugins-host-tool-conformance | P0 — live host-tool conformance probe (first implementation) | area-plugins | allowlist-repair | 1 | in-progress | — | principal-swe-architect | — | — | 2026-08-28-0055 |
| area-plugins-tool-allowlist-fix | P0 — tool-allowlist warnings: root cause and conditional fix | area-plugins | allowlist-repair | 1 | ready | — | principal-swe-infra | host-tool-conformance (in-progress) — **unmet** | — | 2026-08-28-0055 |
