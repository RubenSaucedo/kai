...
| pack-split-first-department | Prove kai-core + personal installs over the boundary | pack-split | first-pack-extracted | 10 | blocked (resume: release-ready) | principal-swe-infra | @operator | generated-pack-trees (shipped ✅ 2026-08-26), migration-doctor (shipped ✅ 2026-08-26) — both met; GitHub Actions emitted no PR check suite | — | 2026-08-26-1538 |
...
| pack-split-onboarding-installer | Honest guided onboarding installer | pack-split | five-pack-split-shipped | 20 | proposed | — | principal-product-manager | generated-pack-trees (shipped ✅ 2026-08-26), migration-doctor (shipped) — both met | — | 2026-08-24-2011 |
...
| pack-split-pack-dependency-manifests | Define generated-pack dependency manifests and install semantics | pack-split | five-pack-split-shipped | 20 | proposed | principal-swe-infra | principal-product-manager | host-gates (completed) | — | 2026-08-26-1420 |
