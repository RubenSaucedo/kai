...
| Release 12b pack-flip record (`1.0.0`) | five-pack-split-shipped | pack-split-release-12b | kai/library/releases/2026-08-27/04-ship-pack-split-release-12b/ship-record.md | **promoted 2026-08-27** -> kai/library/releases/2026-08-27/04-ship-pack-split-release-12b/ship-record.md | **SHIPPED 2026-08-27** (merge `88965c4c…`; core + personal published; monolith retired; production verification 8/8 PASS) |
| Release 12c-1 hardening record (`1.0.1`) | five-pack-split-shipped | pack-split-release-12c-1-hardening | kai/library/releases/2026-08-27/05-ship-pack-split-release-12c-1-hardening/ship-record.md | **promoted 2026-08-27** -> kai/library/releases/2026-08-27/05-ship-pack-split-release-12c-1-hardening/ship-record.md | **SHIPPED 2026-08-27** (PR #184; merge `815680bb…`; exact-main run `33126882590` success; public `v1.0.1`; no department published) |
...
| Architecture review — engineering pack publication (`1.0.3`) | five-pack-split-shipped | pack-split-release-12c-3-engineering | kai/initiatives/pack-split/artifacts/decisions/pack-split-release-12c-3-engineering-architecture-review.md | — | **APPROVED 2026-08-27** at `27804def…`; P0/P1/P2 0/0/0; item remains in-review |
...
chain. PR #174 merged to `main` as `b6db547c…`; main validation run
