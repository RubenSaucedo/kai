...
1. List the files in `<project-root>/<publication-root>/briefings/` matching
   `*-briefing.md`.
...
File path:
`<project-root>/<publication-root>/briefings/<YYYY-MM-DD>-expanded-<topic-slug>.md`.
...
Output: <project-root>/<publication-root>/briefings/<YYYY-MM-DD>-briefing.md
Anything you want me to include or exclude this run?
```

### 2. Build the covered set

Glob `<project-root>/<publication-root>/briefings/*-briefing.md`. For each, read YAML
