...
case is feeding course / certification content into a downstream reader or
narration tool, but the skill itself doesn't assume that downstream — it just
produces tidy markdown.
...
> Generated by `kai-core-web-content-extraction`. Knowledge-check questions
> live in `questions.md`.
