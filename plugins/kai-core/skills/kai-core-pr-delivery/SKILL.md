...
```text
pr-sizing          PR-DELIVERY            kai-core-definition-of-done      workflow-ship
─────────          ───────────            ──────────────────      ─────────────
...
| Is it ready to release? | `kai-core-definition-of-done` |
...
`kai-core-definition-of-done` waives dimensions that do not apply: four sections always,
