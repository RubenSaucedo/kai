...
| Browser automation (Playwright: `web-evaluation`, `web-content-extraction`) | ✅ local + localhost targets | ⚠️ public URLs only; no localhost |
...
[`team-operating-rules`](../skills/team-operating-rules/SKILL.md), and every
