...
| 3 | reviewed | **Clear** | `principal-swe-architect` ratified and the then-current principal-technical-writer role approved exact ref `82e98bcfe595e6d885843e90aa8a704d4478bb45`, both with P0/P1 = 0. Every later path is coordination or initiative record only. |
