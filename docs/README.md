...
| Page | Contents |
| ---- | -------- |
| [Agents & skills](reference/agents-and-skills.md) | The full catalog of all 54 agents and 40 skills, generated from their shipped frontmatter so it cannot drift. |
